...
`,hy="/Lux/assets/ESFERAS-c87049f7.png",my="/Lux/assets/TopBackground-34fa001f.svg",vy="/Lux/assets/VIDRIO-f221c250.png",gy="/Lux/assets/LOGO_2-99c83f9c.svg",yy="/Lux/assets/Decoracion_5-c093bdbb.svg";function xy(){return Ce(fy,{children:[Ce(dy,{children:[Ce(py,{children:[A("h3",{children:"Somos un estudio de -Marketing-"}),A("p",{children:"Especializados y exclusivos"}),A("p",{children:"para el rubro inmobiliario"})]}),A("img",{src:vy,className:"BlurTL"})]}),A("img",{src:yy,className:"Arrows"}),A("img",{className:"Bubbles",src:hy}),A("img",{src:gy,className:"Cross"}),A("img",{src:my,className:"RightBottomCorner"})]})}const wy=T.section`
...
`,Ny="/Lux/assets/Decoracion_3-7e5e457b.svg",zy=[{title:"Lorem Ipsum"},{title:"Lorem Ipsum"},{title:"Lorem Ipsum"},{title:"Lorem Ipsum"},{title:"Lorem Ipsum"},{title:"Lorem Ipsum"}];function Vy(){return Ce(Ly,{children:[A(My,{children:A("h2",{children:"Porfolio"})}),A(Ty,{children:A("p",{children:"Conoce los resultados finales de todos nuestros trabajos."})}),A(_y,{children:zy.map(e=>Ce($y,{children:[A("div",{className:"card"}),A("h3",{children:e.title})]}))}),A("img",{src:Ny,className:"RightTop"})]})}const By=T.section`
...
`,Wy="/Lux/assets/Icono_CM-89c5d715.svg",Gy="/Lux/assets/Icono_MKT-124bff3d.svg",Qy="/Lux/assets/Icono_DSGN-eb3c7594.svg",Yy="/Lux/assets/Icono_Coach-ca3bbd49.svg",Ky="/Lux/assets/Decoracion_4-7cee60b4.svg",Xy=[{title:"Community Manager",img:Wy,className:"CM"},{title:"Marketing Digital",img:Gy},{title:"Diseño Gráfico",img:Qy},{title:"Coach",img:Yy}];function Zy(){return Ce(By,{children:[A(jy,{children:A("h2",{children:"¿Qué Ofrecemos?"})}),A(Uy,{children:Xy.map(e=>Ce(Hy,{children:[A("img",{src:e.img,className:e.className}),A("h3",{children:e.title})]}))}),A("img",{src:Ky,className:"BottomDots"})]})}const Jy="/Lux/assets/Footer_degradado-6a92d57f.svg",qy=T.section`
...
`;const SS=T.div`
  ...
  background-color: #000;
  color: #fff;
`;function CS(){return A(SS,{children:"Desarrollado por Luis Taffelli - Copyright ©2022"})}const ES="/Lux/assets/Logo_ig-2f1c8df0.svg",kS="/Lux/assets/Logo_Wsp-8ebf1325.svg",PS="/Lux/assets/Logo_Mail-2d8121f7.svg",OS=T.section`
