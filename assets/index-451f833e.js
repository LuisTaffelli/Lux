...
`;const Tl="/assets/Logo-95830ee1.svg";function Bd({theme:e,...t}){const n={dark:Tl,light:Tl,grey:Tl},r=n[e]||n.dark;return S("img",{src:r,alt:"MarketAllocator",...t})}const M={mobile:"max-width: 428px",ipad:"max-width: 820px",pc:"min-width: 830px",pcFullRes:"min-width: 1600px",pcFRN:1600,pcN:830,ipadN:820,mobileN:428},My=D.div`
  display: flex;
  flex-flow: column;
...
`;fe`
  ...
  `;function jy({searchbar:e,links:t,user:n,togglePop:r,SectionSetter:o}){Hm();const i=Fa(),a=(l,s)=>{if(l==="Contacto")return o(l),window.scrollTo({top:document.documentElement.scrollHeight,behavior:"smooth"}),null;if(!s)return null;o(l),i(s),window.scrollTo({top:0,behavior:"smooth"})};return S(wr,{children:S(Vy,{children:t==null?void 0:t.map(({to:l,label:s,anchorTo:u},c)=>S("li",{children:S(zy,{to:l,onClick:()=>a(u,l),children:s})},c))})})}function jd({user:e,links:t,state:n,toggle:r,mobile:o,togglePop:i,searchbar:a,SectionSetter:l}){return S(o?By:jy,{user:e,links:t,state:n,toggle:r,togglePop:i,searchbar:a,SectionSetter:l})}const Hy="/assets/Menu_Hambur-66376cc3.svg",Uy="/assets/Menu_Close_Amarillo-e8df7132.svg",Hd=D.header`
  padding: 1rem 0;
  position: sticky;
  top: 0;
  left: 0;
...
`;function Wy({state:e,toggle:t,SectionSetter:n}){const r=Hm(),o=x.exports.useRef(),i=M1(),[a,l]=x.exports.useState("transparent"),s=m=>{l("--primary-dark1"),window.pageYOffset===0&&l("--transparent")};x.exports.useEffect(()=>(window.addEventListener("scroll",s),()=>window.removeEventListener("scroll",s)),[]);const{state:u,show:c,hide:f}=Vm(!1);return i?S(Hd,{isLanding:r,children:j(Ud,{isSession:i,children:[S("button",{className:"menu",onClick:t,type:"button",children:S(T1,{size:30})}),S(Wd,{children:S(Ln,{className:"logo-container",to:"/",children:S(Bd,{theme:r?"dark":"light",className:"logo"})})})]})}):S(wr,{children:S(Hd,{isLanding:r,ref:o,color:a,onScroll:s,show:e,children:j(Ud,{children:[S(jd,{links:Id,mobile:!0,state:e,toggle:t,SectionSetter:n}),S(Wd,{children:S(Ln,{className:"logo-container",to:"/",children:S(Bd,{theme:r?"dark":"light",className:"logo"})})}),S(jd,{links:Id,togglePop:c,SectionSetter:n})]})})})}fe`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 100%;
...
`,cx="/assets/ESFERAS-c87049f7.png",dx="/assets/TopBackground-34fa001f.svg",fx="/assets/Vidrio_5-389719f9.png",px="/assets/LOGO_2-99c83f9c.svg",mx="/assets/Decoracion_5-c093bdbb.svg";function hx(){const[e,t]=x.exports.useState(null);return j(ax,{fluid:!0,className:"w-100 h-100",children:[j(sx,{children:[j(ux,{children:[S("h3",{children:"Somos un estudio de -Marketing-"}),S("p",{className:"fs-4",children:"Especializados y exclusivos"}),S("p",{className:"fs-4",children:"para el rubro inmobiliario"})]}),S("img",{src:fx,className:"BlurTL"}),S("img",{className:"Bubbles",src:cx})]}),S("img",{src:mx,className:"Arrows"}),S("img",{src:px,className:"Cross"}),S("img",{src:dx,className:"RightBottomCorner"}),S(On,{className:"p-5 my-5",children:j(lx,{className:"py-5 my-5",children:[S(On,{children:S(yn,{children:S("h3",{className:"text-light",children:"Ya está todo preparado"})})}),S(On,{children:S(yn,{children:S("h3",{className:"text-light",children:"¡ACTUALIZÁ TU MARCA AHORA!"})})}),S(On,{children:S(rx,{status:e,children:S(ix,{to:"/Planes",className:"text-light",children:S(ox,{type:"button",onClick:()=>t(n=>!n),children:S("h2",{children:"VER PLANES"})})})})})]})})]})}const gx=D.div`
...
`,Ax="/assets/Icono_CM-89c5d715.svg",Tx="/assets/Icono_MKT-124bff3d.svg",Mx="/assets/Icono_DSGN-eb3c7594.svg",$x="/assets/Icono_Coach-ca3bbd49.svg",Lx="/assets/Decoracion_4-7cee60b4.svg",Nx=[{title:"Community<br>Manager",img:Ax,className:"CM",lightText:"Estar activo en redes es importante para generar posibles compradores.",boldText:["Diseños de estrategias de comunicación, atención a consultas/dudas. Gestionamos y administramos tus redes."]},{title:"Marketing Digital",img:Tx,lightText:"Una estrategia de comunicación es esencial para atraer la atención hacia tu marca",boldText:["Análisis y acumulación de datos, Identificación de oportunidades y problemas, atracción de público ideal."]},{title:"Diseño Gráfico",img:Mx,lightText:"Diferenciarse de su competencia hace a su marca memorable, lo que despierta interés.",boldText:["Creación de logo, Identidad visual, realización de piezas para R.R.S.S"]},{title:"Coaching",img:$x,lightText:"Para quienes quieran administrar sus propias RRSS ofrecemos unas tutorías prácticas e introductoras.",boldText:["- Diseño","- Community Manager","- Rubro inmobiliario"]}];function _x(){return j(Fx,{children:[S(Ix,{children:S("h2",{children:"¿Qué Ofrecemos?"})}),S(Dx,{children:Nx.map((e,t)=>j(Rx,{children:[S("img",{src:e.img,className:e.className}),S("h3",{className:"fs-3",dangerouslySetInnerHTML:{__html:e.title}}),S("p",{className:"fs-6",children:e.lightText}),e.boldText.map(n=>S("h5",{className:"fs-7",children:n},n))]},t+e.title))}),S("img",{src:Lx,className:"BottomDots"})]})}D.div`
  ...
  opacity: 0;
`;function zx({ScrollTo:e}){return x.exports.useState(!1),j(Gy,{children:[S(hx,{}),S(Ox,{Scroll:e}),S(_x,{})]})}const Vx="/assets/wsp_boton-cfe5813b.svg",Bx="/assets/wsp_boton_oscuro-a2500823.svg",ea=D.section`
	${e=>console.log(e)}
	position: relative;
...
`;function Co(e){return e?`https://api.whatsapp.com/send?phone=5491162471651&text=${e}`:"https://api.whatsapp.com/send?phone=5491162471651&text=Hola! Quiero conocer más acerca de su empresa!"}function jx({Title:e,PackName:t,PackDescription:n,PackContent:r,Index:o,Information:i,Extras:a}){const l=x.exports.useContext(To),s=x.exports.useRef(),u=x.exports.useRef(),c=x.exports.useRef(),[f,m]=x.exports.useState(new Map),y=w=>{const{value:d,id:p}=w.target,h=f;if(h.has(p)){h.delete(p);return}h.set(p,d),m(h)},g=()=>f.size?Co(`Hola! Me gustaría solicitar el plan de ${e}-${t.split("#")[1]} con algunos Extras`):Co(`Hola! Me gustaría solicitar el plan de ${e}-${t.split("#")[1]}`),v=()=>{const w=[];f.forEach(p=>{w.push(p)});const d={PackName:t.split("#")[1],ExtraOptions:w.join("-")};l.PlanHandler(d),l.ChangeFlag()};return x.exports.useEffect(()=>{s.current.innerHTML=n},[s]),x.exports.useEffect(()=>{u.current.innerHTML=r},[u]),x.exports.useEffect(()=>{!c.current||(c.current.innerHTML=i)},[c]),o%2!==0?S(ea,{children:j(ta,{children:[j(na,{children:[j("div",{className:"Title fs-1",children:["Pack ",S("span",{className:"Luxed",children:t})]}),S("div",{ref:s,className:"Description fs-6"}),S("div",{className:"Offers fs-6",ref:u}),S("div",{className:"PackInfoPersonalizado",children:S("div",{className:"PersonalizadoLeft",children:a?a.map((w,d)=>j("div",{className:"CustomCheckbox",children:[S("input",{onChange:y,type:"checkbox",id:d+w[0],value:w}),S("label",{htmlFor:d+w[0],children:w})]},d+w[0])):null})}),i?S("div",{ref:c,className:"GreyInfo fs-6"}):null]}),S(ra,{children:S("div",{className:"ColorBox",children:S("div",{className:"Arrow"})})}),j("div",{className:"MediaButtons fs-6",children:[S("button",{onClick:v,type:"button",className:"TextButton",children:"Seleccionar"}),S("button",{type:"button",className:"WhatsappButton",children:S("a",{href:g(),target:"_blank",children:S("div",{className:"WhatsappIcon"})})})]})]})}):S(ea,{Status:"Colored",children:j(ta,{position:"Right",children:[S(na,{position:"Right",children:S("div",{className:"ColorBox",children:S("div",{className:"Arrow"})})}),j(ra,{children:[j("div",{className:"Title fs-1",children:["Pack ",S("span",{className:"Luxed",children:t})]}),S("div",{ref:s,className:"Description fs-6"}),S("div",{className:"Offers fs-6",ref:u}),S("div",{className:"PackInfoPersonalizado",children:S("div",{className:"PersonalizadoLeft",children:a?a.map((w,d)=>j("div",{className:"CustomCheckbox",children:[S("input",{onChange:y,type:"checkbox",id:d+w,value:w}),S("label",{htmlFor:d+w,children:w})]},d+w)):null})}),i?S("div",{ref:c,className:"GreyInfo fs-6"}):null]}),j("div",{className:"MediaButtons fs-6",children:[S("button",{onClick:v,type:"button",className:"TextButton",children:"Seleccionar"}),S("button",{type:"button",className:"WhatsappButton",children:S("a",{href:g(),target:"_blank",children:S("div",{className:"WhatsappIcon"})})})]})]})})}function Hx(){const e=x.exports.useContext(To);return j(ea,{children:[j(ta,{children:[j(na,{children:[j("div",{className:"Title fs-1",children:["Pack ",S("span",{className:"Luxed",children:"#Iniciate"})]}),j("div",{className:"Description fs-6",children:["¿Recién está iniciando en el mercado inmobiliario? ¡En ",S("span",{className:"Luxed",children:"Lux"})," tenemos un pack perfecto con estrategias y herramientas de marketing y diseño para ayudarte a impulsar tu negocio y que arranques con todo!",S("br",{}),"Incluye diseño de logo e identidad corporativa para destacar de la competencia, diseño de papelería, gestión de redes sociales, publicidad en línea y email marketing para conectar aún más con tu público. De esta forma aumentá tu visibilidad, atraé más clientes y hacé crecer tu marca a largo plazo.",S("br",{}),"Para partir con ventaja en este mercado, es necesario que tu marca se distinga del resto con una comunicación e identidad profesional; Contactanos para más información."]}),S("div",{className:"Offers fs-6",children:"Logo - identidad visual - papelería (flyers, cartas, tarjetas de presentación, etc.) - posteos en redes - publicidad (Meta y Google Ads) -  email marketing - cartelería - sitio web."})]}),S(ra,{children:S("div",{className:"ColorBox",children:S("div",{className:"Arrow"})})}),j("div",{className:"MediaButtons fs-6",children:[S("button",{onClick:()=>{const r={PackName:"Reinventate"};e.PlanHandler(r),e.ChangeFlag()},type:"button",className:"TextButton",children:"Seleccionar"}),S("button",{type:"button",className:"WhatsappButton",children:S("a",{href:(()=>Co("Hola! Me gustaría solicitar el plan General - Reinventate"))(),target:"_blank",children:S("div",{className:"WhatsappIcon"})})})]})]}),S("img",{src:lh,className:"RightCorner"})]})}D(yn)`
...
`;function AC(){return j(wr,{children:[S(OC,{}),S(RC,{children:j("div",{className:"IconsContainer",children:[S("a",{href:"#",children:S("img",{className:"IgIcon",src:FC})}),S("a",{href:Co(),target:"_blank",children:S("img",{className:"WspIcon",src:IC})}),S("a",{href:"mailto:lux.somos@gmail.com",children:S("img",{className:"MailIcon",src:DC})})]})})]})}function TC(){const{state:e,toggle:t}=Vm(!1),[n,r]=x.exports.useState("");return j(wr,{children:[S(Wy,{state:e,toggle:t,SectionSetter:r}),j(C1,{children:[S(Si,{element:S(zx,{ScrollTo:n}),exact:!0,path:"/"}),S(Si,{element:S(qx,{}),exact:!0,path:"/Planes"}),S(Si,{element:S(w1,{to:"/"}),path:"*"})]}),S(AC,{}),S(ew,{})]})}Vl.createRoot(document.getElementById("root")).render(S(lt.StrictMode,{children:S(O1,{children:S(I1,{children:S(TC,{})})})}));
